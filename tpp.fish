...
function __fish_tpp_global_optspecs
	string join \n L/socket= scope= json q/quiet config= h/help V/version
end
...
complete -c tpp -n "__fish_tpp_needs_command" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_needs_command" -f -a "ls" -d 'List sessions in the current scope'
complete -c tpp -n "__fish_tpp_needs_command" -f -a "l" -d 'List sessions in the current scope'
complete -c tpp -n "__fish_tpp_needs_command" -f -a "list" -d 'List sessions in the current scope'
...
complete -c tpp -n "__fish_tpp_needs_command" -f -a "doctor" -d 'Check tmux availability and print resolved paths and scope'
...
complete -c tpp -n "__fish_tpp_using_subcommand run" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand r" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand new" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand n" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand ls" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
complete -c tpp -n "__fish_tpp_using_subcommand ls" -l config -d 'Config file path (default: ~/.config/tpp/config.toml)' -r -F
complete -c tpp -n "__fish_tpp_using_subcommand ls" -s a -l all -d 'Show all tpp sessions, not just the current scope'
...
complete -c tpp -n "__fish_tpp_using_subcommand l" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
complete -c tpp -n "__fish_tpp_using_subcommand l" -l config -d 'Config file path (default: ~/.config/tpp/config.toml)' -r -F
complete -c tpp -n "__fish_tpp_using_subcommand l" -s a -l all -d 'Show all tpp sessions, not just the current scope'
...
complete -c tpp -n "__fish_tpp_using_subcommand list" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
complete -c tpp -n "__fish_tpp_using_subcommand list" -l config -d 'Config file path (default: ~/.config/tpp/config.toml)' -r -F
complete -c tpp -n "__fish_tpp_using_subcommand list" -s a -l all -d 'Show all tpp sessions, not just the current scope'
...
complete -c tpp -n "__fish_tpp_using_subcommand attach" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand a" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand send" -s t -l target -d 'Target session (default: the sole session in scope)' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand send" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand s" -s t -l target -d 'Target session (default: the sole session in scope)' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand s" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand paste" -s t -l target -d 'Target session (default: the sole session in scope)' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand paste" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand cat" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand cap" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand capture" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand tail" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand follow" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand wait" -s t -l target -d 'Target session (default: the sole session in scope)' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand wait" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand rm" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
complete -c tpp -n "__fish_tpp_using_subcommand rm" -l config -d 'Config file path (default: ~/.config/tpp/config.toml)' -r -F
complete -c tpp -n "__fish_tpp_using_subcommand rm" -l all -d 'Remove every tpp session in the current scope'
...
complete -c tpp -n "__fish_tpp_using_subcommand kill" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
complete -c tpp -n "__fish_tpp_using_subcommand kill" -l config -d 'Config file path (default: ~/.config/tpp/config.toml)' -r -F
complete -c tpp -n "__fish_tpp_using_subcommand kill" -l all -d 'Remove every tpp session in the current scope'
...
complete -c tpp -n "__fish_tpp_using_subcommand remove" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
complete -c tpp -n "__fish_tpp_using_subcommand remove" -l config -d 'Config file path (default: ~/.config/tpp/config.toml)' -r -F
complete -c tpp -n "__fish_tpp_using_subcommand remove" -l all -d 'Remove every tpp session in the current scope'
...
complete -c tpp -n "__fish_tpp_using_subcommand exit" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand e" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand quit" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand clear" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand clr" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand has" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand rename" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand config; and not __fish_seen_subcommand_from path show edit init" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand config; and __fish_seen_subcommand_from path" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand config; and __fish_seen_subcommand_from show" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand config; and __fish_seen_subcommand_from edit" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand config; and __fish_seen_subcommand_from init" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand init" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand doctor" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand completions" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand has-session" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand new-session" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand attach-session" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand kill-session" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand list-sessions" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand set-buffer" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand paste-buffer" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand send-keys" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand capture-pane" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
...
complete -c tpp -n "__fish_tpp_using_subcommand x" -l scope -d 'Scope directory to operate in, or `none` to disable scoping' -r
